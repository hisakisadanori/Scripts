...
public class Pra_waterbutton : MonoBehaviour
{
    ...
    public void water_start(float C_ido, float C_keido)
    {
        ...
        float ido = System.Convert.ToSingle(currentUser["Pra_ido"]);
        float keido = System.Convert.ToSingle(currentUser["Pra_keido"]);
